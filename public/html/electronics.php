...
<body>
        ...
        <div class="container sec-all-list-bre">
            <div class="row">
                <ul>
                    ...
                    <li><span>Shop electronics on Gumtree</span>
                    </li>
                </ul>
                <h2>Electronics for Rent & Sale</h2>

                <h1>Shop electronics on Salonegoo!</h1>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="nav nav-tabs">
                        <li><a class="active" data-toggle="tab" href="#home">Mobile Phones</a></li>
                        <li><a data-toggle="tab" href="#menu1">Computers</a></li>
                        <li><a data-toggle="tab" href="#menu2">Video Games & Consoles</a></li>
                        <li><a data-toggle="tab" href="#menu3">Audio & Music Equipment</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="bms">
                        <li>
                            <div class="licon"><img src="img/camera.png"><span>Cameras</span></div>
                            <ul>
                        ...
                        <li>
                            <div class="licon"><img src="img/phone.png"><span>Cell Phones</span></div>
                            <ul>
                        ...
                        <li>
                            <div class="licon"><img src="img/computer.png"><span>Computers</span></div>
                            <ul>
                        ...
                        <li>
                            <div class="licon"><img src="img/tv.png"><span>TVs & Audio</span></div>
                            <ul>
                        ...
                        <li>
                            <div class="licon"><img src="img/video.png"><span>Video Games</span></div>
                            <ul>
            ...
            <div class="row">
                <div class="text-center">
                    <div class="sub-tit text-left">
                        <div class="sp-t">
                            <div>
                                <h2>Browse Samsung Phones in South Africa</h2>
                                <small>Best buys in phones</small>
                            </div>
                            <a href="#">View All <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                    <path d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"></path>
                                </svg></a>
                            ...
                            <li>
                                <div class="news-hban-box">
                                    ...
                                    <div class="txt">
                                        ...
                                        <span class="news-date"><i class="fas fa-map-marker"></i> Blueberg</span>
                                    </div>
                                    <a href="details.php" class="fclick"></a>
                                </div>
                            </li>
                            <li>
                                <div class="news-hban-box">
    ...
    <section class="browser mb-5">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="sub-tit text-left mb-5">
                        <div class="sp-t">
                            <div>
                ...
                <div class="col-sm-12">
                    <ul class="typePeroperty">
                        ...
                        <li>
                            <a href="#">
                                <img src="img/f6.png">
                                <strong>HP Comaq Laptops</strong>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="img/f4.png">
                                <strong>Dell Laptops</strong>
                            </a>
                        </li>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="colbanner">
                        ...
                        <div class="coltext">
                            <h2>Stay Safe While Selling Electronics</h2>
                ...
                <div class="col-sm-6">
                    <div class="textBanner">
                        <h2>Popular Buyer and Seller Tips</h2>
                        <h3>Buyer Tips</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper nisl vel sem fringilla, sed semper leo ullamcorper.</p>
                        <ul>
                            <li>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper nisl vel sem fringilla, sed semper leo ullamcorper.
                            </li>
                            <li>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper nisl vel sem fringilla, sed semper leo ullamcorper.
                            </li>
                        ...
                        <div class="accordion" id="faq">
                            <div class="card">
                                <div class="card-header" id="faqhead1">
                                    <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1">Lorem ipsum dolor sit amet consectetur.</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="faqhead2">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="faqhead3">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="quote-pop">
                            ...
                            <form method="post" name="popup_enquiry_form" id="popup_enquiry_form">
                                ...
                                <button disabled="disabled" type="submit" id="popup_enquiry_submit" name="popup_enquiry_submit" class="btn btn-primary"> Log In To Submit </button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="quote-pop">
                            ...
                            <form method="post" name="popup_claim_form" id="popup_claim_form">
                                <fieldset disabled="disabled">
                                    <input type="hidden" class="form-control" name="listing_id" value="381" placeholder="" required>
                                    <input type="hidden" class="form-control" name="listing_user_id" value="37" placeholder="" required>
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Enter this business email id*" required="required" value="" name="enquiry_email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" title="Invalid email address">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="file" class="form-control" name="enquiry_image" placeholder="Identification Proof *" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" rows="3" name="enquiry_message" placeholder="Enter your query and why claim this business"></textarea>
                                    </div>
                                    <input type="hidden" id="source">
                                    <button type="submit" disabled="disabled" id="popup_claim_submit" name="popup_claim_submit" class="btn btn-primary">Log In To Submit
                                    </button>
                                </fieldset>
                            </form>
