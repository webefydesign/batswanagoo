               ...
               <div class="panel-group">
                 <div class="panel panel-default">
                    ...
                    <div class="panel-body chatss">
                        ...
                        <form>
                          <div class="p-emails">
                            <fieldset class="em-20 ">
                                <strong>Email Notifications</strong>
                           </fieldset>
                           <fieldset class="em-field">
                              <div class="rmD">
                                <label>Hot deals and recommendations</label>
                             ...
                             <fieldset class="em-field">
                              <div class="rmD">
                                <label>Info about your Ads </label>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary active">
                                      <input type="radio" name="options" id="option1" checked=""> Yes
                                    </label>
                           ...
                           <div class="p-emails">
                              ...
                              <fieldset class="em-field">
                              <div class="rmD">
                                <label>SMS info notification </label>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary active">
                                      <input type="radio" name="options" id="option1" checked=""> Yes
                                    </label>
                                ...
                                <fieldset class="em-field">
                              <div class="rmD">
                                <label>Jiji web notifications </label>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary active">
                                      <input type="radio" name="options" id="option1" checked=""> Yes
                                    </label>
