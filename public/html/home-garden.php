	...
	<div class="container sec-all-list-bre">
			<div class="row">
				<ul>
					...
					<li><span>Home & Garden</span>
					</li>
				</ul>
				<h2>Turn your house into a home</h2>
				
				<h1>Shop garden on Salonegoo!</h1>
			</div>
		</div>
</section>
		...
		<div class="row">
			<div class="col-sm-12">
				<ul class="nav nav-tabs">
					<li><a class="active" data-toggle="tab" href="#home">Furniture</a></li>
					<li><a data-toggle="tab" href="#menu1">Home Appliances</a></li>
					<li><a data-toggle="tab" href="#menu2">DIY & Tools</a></li>
					<li><a data-toggle="tab" href="#menu3">Garden & Braai</a></li>
				...
				<div class="col-sm-12">
					<ul class="typePeroperty">
						...
						<li>
							<a href="#">
								<img src="img/g2.png">
								<strong>DIY & Tools</strong>
							</a>
						</li>
						<li>
							<a href="#">
								<img src="img/g3.png">
								<strong>Garden & Braai</strong>
						...
						<li>
							<a href="#">
								<img src="img/g1.png">
								<strong>Antiques & Collectables</strong>
							</a>
						</li>
						<li>
							<a href="#">
								<img src="img/g6.png">
								<strong>Beds & Headboards</strong>
							</a>
						</li>
						<li>
							<a href="#">
            ...
            <div class="row">
               <div class="text-center">
                  <div class="sub-tit text-left">
                     <div class="sp-t">
                       <div>
                           <h2>Browse Home Appliances For Sale in South Africa</h2>
