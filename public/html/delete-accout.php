                    ...
                    <div class="panel-body">
                        ...
                        <form>
                          <div class="p-forme">
                             ...
                             <p><small>You will not be able to log in to your profile anymore and all your account history will be deleted without the possibility to restore</small></p>
                            ...
                            <fieldset>
                              <div class="pf-divs">
                                ...
                                <select class="form-control mb-3">
                                      ...
                                      <option>I have found nothing interesting in Saloongoo</option>
                                      <option>Other Reason</option>
                                </select>

                                <div class="yours">
                                  <legend>Your Reason</legend>
                                <textarea class="form-control" placeholder="Your Reason">
