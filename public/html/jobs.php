...
<section class="all-list-bre searchbanner" style="background-image: url('img/garden.jpg');">
	<div class="container sec-all-list-bre">
			<div class="row">
				...
				<h1>Join the millions that have found their dream job on Salonegoo!</h1>
			</div>
		</div>
</section>
		...
		<div class="row">
			<div class="col-sm-12">
				<ul class="nav nav-tabs">
					<li><a class="active" data-toggle="tab" href="#home">Admin Jobs</a></li>
					<li><a data-toggle="tab" href="#menu1">Hospitality Jobs</a></li>
					<li><a data-toggle="tab" href="#menu2">General Worker Jobs</a></li>
					<li><a data-toggle="tab" href="#menu3">Sales Jobs</a></li>
					...
					<div id="home" class="tab-pane fade active show">
						...
						<div class="formProperty">
							<form>
								<div class="formD">
									<div class="i-div">
										<select name="JobType" class="form-control us-select-hide">
										   <option data-placeholder="Enter the Job Type">Enter the Job Type</option>
									...
									<div class="i-div">
										<select name="AdvertisedBy" class="form-control us-select-hide">
										   <option data-placeholder="Enter the Advertised By">Enter the Advertised By</option>
										   <option value="">All</option>
				...
				<div class="col-sm-12">
					<ul class="typePeroperty">
						...
						<li>
							<a href="#">
								<img src="img/e1.png">
								<strong>Northern Capes</strong>
							</a>
						</li>
						<li>
							<a href="#">
								<img src="img/e1.png">
								<strong>Display Cabinets</strong>
							</a>
						</li>
						<li>
							<a href="#">
            ...
            <div class="row">
               <div class="text-center">
                  <div class="sub-tit text-left">
                     <div class="sp-t">
                       <div>
                           <h2>Browse All Jobs in South Africa</h2>
                           <small>Best jobs</small>
                        </div>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="colbanner">
						...
						<div class="coltext">
							<h2>Need cash in a flash? Here are a few ideas</h2>
