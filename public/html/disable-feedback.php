                    ...
                    <div class="panel-body chatss">
                        ...
                        <form>
                          <div class="p-forme">
                           ...
                           <hr>
                           <p><small>Disabling feedback is available only for sellers with VIP+, Diamond, Enterprise subscriptions.</small></p>
                           <hr>
                         </div>
                         ...
                         <div class="p-forme">
                            <button type="submit" class="sal-save">Subscribe</button>
                         </div>
