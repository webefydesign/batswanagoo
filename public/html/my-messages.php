      ...
      <!-- Global site tag (gtag.js) - Google Analytics -->
          ...
          <style type="text/css">
            .full-bot-book {
             ...
             .table thead th {font-size: 17px;padding: 10px 0 !important;}
          </style>
       </head>
   <body>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="pname">
                                                <img src="img/m2.jpg">
                                                <strong>Iphone 6 16 GB</strong>
                                            </a>
                                        </td>
                                        <td><label class="badgelabel">Mobile</label></td>
                                        <td><a href="#">+00 1234567</a></td>
                                        <td><span class="textlimti">Hi, I’m interested in 2 Brand New Sealed Boxes Samsung Galaxy A33 5G 128G Both Blue Both Dual sim.4700 Each. Please contact me. Thanks!</span></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>
                            ...
                            <table class="table  table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="edits"></a>
                                            <a href="#" class="delets"></a>
                                            <a href="#" class="viewss"></a>                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>
                                            <a href="#" class="pname">
                                                <img src="img/mob7.png">
                                                <strong>IPhone No SIGNAL? Cell C or Telkom ONLY.s</strong>
                                            </a>
                                        </td>
                                        <td><label class="badgelabel">Mobile</label></td>
                                        <td>$ 1600</td>
                           ...
                           <table class="table  table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$ 1600</td>
                                        <td>19/09/2020</td>
                                        <td><label class="badge badge-dark">Expired</label></td>
                                        <td>
                                            <a href="#" class="edits"></a>
                                            <a href="#" class="delets"></a>
                                            <a href="#" class="viewss"></a>                                            
                           ...
                           <table class="table  table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$ 1600</td>
                                        <td>19/09/2020</td>
                                        <td><label class="badge badge-dark">Inactive</label></td>
                                        <td>
                                            <a href="#" class="edits"></a>
                                            <a href="#" class="delets"></a>
                                            <a href="#" class="viewss"></a>                                            
