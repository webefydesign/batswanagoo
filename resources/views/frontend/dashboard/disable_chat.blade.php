                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body chatss">
                                ...
                                <form action="{{ url('dashboard/disable-chats') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="p-forme">
                                        <fieldset class="rmlabel">
                                            <div class="rmD">
                                                <label>Recieve Messages</label>
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label
                                                        class="btn btn-secondary {{ $user->chats == 0 ? 'active' : '' }}">
                                                        <input type="radio" name="chats" id="option1" value="0"
                                                            {{ $user->chats == 0 ? 'checked' : '' }}> Yes
                                                    </label>
                                                    <label
                                                        class="btn btn-secondary {{ $user->chats == 1 ? 'active' : '' }}">
                                                        <input type="radio" name="chats" id="option2" value="1"
                                                            {{ $user->chats == 1 ? 'checked' : '' }}> No
                                                    </label>
                                                </div>
                                            </div>
                                        </fieldset>
