...
<div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        ...
        <form action="{{route('testimonials.delete')}}" method="POST" id="del_form" form="del_form">
            {{csrf_field()}}
          ...
          <table class="js-table-checkable table table-hover table-vcenter">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center fs-sm">
                  <a class="btn btn-sm btn-alt-secondary" href="{{route('testimonials.status', $v->id)}}" data-bs-toggle="tooltip" title="{{($v->is_active==1)?'Un-publish':'Publish'}}">
                    <i class="fa fa-fw {{($v->is_active==1)?'fa-eye-slash':'fa-eye'}}"></i>
                  </a>
                  <a class="btn btn-sm btn-alt-secondary edit-testimonial" data-url="{{route('testimonials.update', $v->id)}}" data-name="{{$v->name}}" data-image="{{$v->image}}" data-order="{{$v->sort_order}}" data-designation="{{$v->designation}}" data-test="{{$v->testimonial}}" href="javascript:;" data-bs-toggle="tooltip" title="Edit">
    ...
    <div class="modal-content">
      <form action="{{route('testimonials.store')}}" method="POST">
        <div class="block block-rounded block-transparent mb-0">
          <div class="block-header block-header-default">
            <h3 class="block-title">Add New Testimonial</h3>
            <div class="block-options">
          ...
          <div class="block-content fs-sm">            
            ...
            <div class="form-group pb-1">
                ...
                <textarea class="form-control" placeholder="Testimonial" name="testimonial" required></textarea>
            </div>
            <div class="form-group">
                <label for="">Image</label>
                <div class="input-group pull-left">
                    <span class="input-group-btn">
                        <a data-input="imgTestimonial" class="btn btn-success image-placeholder" style="padding:4px 10px;"><i class="fa fa-picture-o"></i> Choose</a>
                    </span>
                    <input id="imgTestimonial" class="form-control input-sm" type="text" name="image" required>
                </div>
            </div>
            <div class="form-group pb-1">
        ...
        <div class="block block-rounded block-transparent mb-0">
          ...
          <div class="block-content fs-sm">   
            <div class="row pb-1">
                ...
                <div class="form-group col-md-6">
                    <label for="">Designation</label>
                    <input type="text" class="form-control" placeholder="Designation" name="designation" id="edit-designation">
                </div>
            </div>
            <div class="form-group pb-1">
                <label for="">Testimonial</label>
                <textarea class="form-control" placeholder="Testimonial" name="testimonial" required id="edit-test"></textarea>
            </div>
            <div class="form-group">
                <label for="">Image</label>
                <div class="input-group pull-left">
