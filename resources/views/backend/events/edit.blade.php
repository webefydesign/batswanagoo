          ...
          <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
              ...
              <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item">
                  <a class="link-fx" href="{{route('events.index')}}">Events</a>
                </li>
                    ...
                    <div class="block-content">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mt-2">
                                ...
                                <input name="venue" class="form-control" type="text" value="{{$data['venue']}}">
                            </div>
                            <div class="col-md-4 form-group mt-2">
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content p-1">
                        <div class="form-group">
                            ...
                            <strong>Image Size: <small>915 × 385 pixels</small></strong>
                        </div>
                    </div>
                </div>
