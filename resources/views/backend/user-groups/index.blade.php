...
<div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        ...
        <form action="{{route('usergroups.delete')}}" method="POST" id="del_form" form="del_form">
            {{csrf_field()}}
            <button class="btn btn-outline-danger me-1 mb-3" type="button" id="deleteAll"> <i class="fas fa-trash-alt"></i> Delete </button>        
        </form>
        <a href="{{route('usergroups.create')}}" class="btn btn-outline-success me-1 mb-3">
  ...
  @if(Session::has('success'))
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">All Groups</h3>
          ...
          <table class="js-table-checkable table table-hover table-vcenter">
            <thead>
              <tr>
                ...
                <th class="d-none d-md-table-cell">No. of Users</th>
