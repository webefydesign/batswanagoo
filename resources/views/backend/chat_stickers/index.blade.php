...
<div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        ...
        <form action="{{route('chat-stickers.delete')}}" method="POST" id="del_form" form="del_form">
            {{csrf_field()}}
  ...
  @if(Session::has('success'))
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">All Stickers</h3>
          ...
          <table class="js-table-checkable table table-hover table-vcenter">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 100px;">Sticker</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center fs-sm">
                  <img src="{{$v->sticker??asset('placeholder.png')}}" class="img-responsive img-thumbnail" alt="*" style="max-height:60px;">
                </td>
                <td class="d-none d-md-table-cell fs-sm">{{$v->name}}</td>
                <td class="d-none d-md-table-cell fs-sm">{{$v->sort_order}}</td>
                ...
                <td class="text-center fs-sm">
                  <a class="btn btn-sm btn-alt-secondary" href="{{route('chat-stickers.status', $v->id)}}" data-bs-toggle="tooltip" title="{{($v->is_active==1)?'Un-publish':'Publish'}}">
                    <i class="fa fa-fw {{($v->is_active==1)?'fa-eye-slash':'fa-eye'}}"></i>
                  </a>
                  <a class="btn btn-sm btn-alt-secondary edit-sticker" data-url="{{route('chat-stickers.update', $v->id)}}" data-name="{{$v->name}}" data-sticker="{{$v->sticker}}" data-order="{{$v->sort_order}}" href="javascript:;" data-bs-toggle="tooltip" title="Edit">
...
<div class="modal" id="addNewModal" tabindex="-1" role="dialog" aria-labelledby="addNewModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="{{route('chat-stickers.store')}}" method="POST">
        <div class="block block-rounded block-transparent mb-0">
          <div class="block-header block-header-default">
            <h3 class="block-title">Add New Sticker</h3>
            <div class="block-options">
            ...
            <div class="form-group">
                ...
                <div class="input-group pull-left">
                    <span class="input-group-btn">
                        <a data-input="stickerInput" class="btn btn-success image-placeholder" style="padding:4px 10px;"><i class="fa fa-picture-o"></i> Choose</a>
                    </span>
                    <input id="stickerInput" class="form-control input-sm" type="text" name="sticker" required>
                </div>
            </div>
        ...
        <div class="block block-rounded block-transparent mb-0">
          ...
          <div class="block-content fs-sm">            
            <div class="form-group">
                ...
                <div class="input-group pull-left">
                    <span class="input-group-btn">
                        <a data-input="editSticker" class="btn btn-success image-placeholder" style="padding:4px 10px;"><i class="fa fa-picture-o"></i> Choose</a>
                    </span>
                    <input id="editSticker" class="form-control input-sm" type="text" name="sticker" required>
                </div>
            </div>
            <div class="form-group pb-1">
              <label for="">Name</label>
...
<script>
  ...
  $('.edit-sticker').click(function(){
    $("#editForm").attr('action', $(this).data('url'));
    $("#editSticker").val($(this).data('sticker'));
