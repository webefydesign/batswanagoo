...
@endsection
@section('content')
<form action="{{route('salonegoo_faqs.store')}}" method="POST">
                ...
                <div class="block block-rounded mt-3 pb-3">
                    ...
                    <div class="block-content">
                        <div class="col-md-4 form-group pb-2">
                            ...
                            <input type="text" name="category_name" class="form-control light-fields" placeholder="Category Name" required>
                        </div>
