          ...
          <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
              ...
              <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item">
                  <a class="link-fx" href="{{route('blogs.index')}}">Blogs</a>
                </li>
        ...
        <div class="row">
                    ...
                    <div class="block-content">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mt-2">
                                ...
                                <input name="publish_date" class="form-control" type="date" value="{{$data['publish_date']}}">
                            </div>  
                            ...
                            <div class="col-md-3 form-group mt-2">
                                ...
                                <input name="views_count" class="form-control" type="number" value="{{$data['views_count']}}">
                            </div>                                        
                            <div class="col-md-2 form-group mt-2">
                                <label for="">Sort Order</label>
                                <input name="sort_order" class="form-control" type="number" value="{{$data['sort_order']}}">
                            </div>   
                        </div>                        
                    </div>
                </div>
            ...
            <div class="col-md-3">
                        ...
                        <ul id="categories-list">
                            ...
                            <li>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="catCheck{{$cat->id}}" name="categories[]" value="{{$cat->id}}" {{(in_array($cat->id, $current_cats))?'checked':''}}>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="form-group">
                        <div class="form-check form-switch form-check-inline">
                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{(isset($data['is_featured']) && $data['is_featured']=='1')?'checked':''}}>
