...
<div class="bg-body-light">
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        ...
        <form action="{{route('blogs-categories.delete')}}" method="POST" id="del_form" form="del_form">
            {{csrf_field()}}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center fs-sm">
                  <a class="btn btn-sm btn-alt-secondary" href="{{route('blogs-categories.status', $v->id)}}" data-bs-toggle="tooltip" title="{{($v->is_active==1)?'Un-publish':'Publish'}}">
                    <i class="fa fa-fw {{($v->is_active==1)?'fa-eye-slash':'fa-eye'}}"></i>
                  </a>
                  <a class="btn btn-sm btn-alt-secondary edit-item" data-url="{{route('blogs-categories.update', $v->id)}}" data-title="{{$v->title}}" data-desc="{{$v->short_description}}" data-order="{{$v->sort_order}}" data-slug="{{$v->slug}}" href="javascript:;" data-bs-toggle="tooltip" title="Edit">
